...
# Routers & Background Tasks (FAISS removed from imports)
...
# ==========================================
# 🛡️ CORS SETTINGS (Safe for Production)
# ==========================================
_cors_raw = os.getenv(
    "CORS_ORIGINS",
    "http://localhost:5173,http://127.0.0.1:5173,http://localhost:3000"
...
if _cors_raw == "*":
    allowed_origins = ["*"]
    _allow_credentials = False   # browser wildcard par credentials reject karta hai
else:
    allowed_origins = [o.strip() for o in _cors_raw.split(",") if o.strip()]
    _allow_credentials = True
